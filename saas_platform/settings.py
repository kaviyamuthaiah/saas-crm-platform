...
MIDDLEWARE = [
    ...
    # Custom: identifies current tenant from the logged-in user
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Injects current tenant into every template context
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': config('DB_PASSWORD', default='radhai123'),
